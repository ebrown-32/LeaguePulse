...
export default async function SeasonStatsPage() {
  ...
  try {
    ...
    const leagueAvgScore = teamPerformances.reduce((sum, team) => sum + team.avgScore, 0) / teamPerformances.length;
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm text-gray-400">
            Week {nflState.week} • {league.season} Season
          </div>
        </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr>
                    ...
                    {Array.from({ length: nflState.week }, (_, i) => (
    ...
    return (
      <ErrorMessage
        title="Failed to Load Season Stats"
        message={error instanceof Error ? error.message : 'An unexpected error occurred while fetching season stats. Please check your league ID and try again.'}
      />
    );
  }
} 