  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Next-Gen Stats</h1>
        <select
          className="bg-white/5 border-white/10 rounded-md text-white focus:border-blue-500 focus:ring-blue-500"
      ...
      <div className={`grid gap-6 md:grid-cols-2 lg:grid-cols-3 ${loading ? 'opacity-50' : ''}`}>
        {metrics.map((team) => (
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  ...
                  <p className="text-2xl font-bold">{team.points.average.toFixed(1)}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-400">vs. Avg</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm text-gray-400">Most Explosive</p>
                <p className="text-lg font-medium">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm text-gray-400">Most Clutch</p>
                <p className="text-lg font-medium">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm text-gray-400">Highest Scoring</p>
                <p className="text-lg font-medium">
