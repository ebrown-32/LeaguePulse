...
export async function POST(request: Request) {
  ...
  const system = [
    ...
    '- Each trade line names who GETS and who GIVES UP every asset. Never say a',
    '  team traded a player away unless its own "gives up" list names him, and',
    '  never attribute a trade to a team absent from that line.',
